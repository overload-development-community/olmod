...
namespace GameMod.Scoreboards {
    ...
    public class MonsterballScoreboard {
        private const float col1 = -330f;
        private const float col2 = -80f;
        private const float col3 = 0f;
        private const float col4 = 80f;
        private const float col5 = 160f;
        private const float col6 = 220f;
        private const float col7 = 280f;
        private const float col8 = 350f;
