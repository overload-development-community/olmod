...
namespace GameMod {
    ...
    class MPTweaksAcceptedToLobby
    {
        private static void Prefix(AcceptedToLobbyMessage accept_msg)
        {
            ...
            caps.Add("SupportsTweaks", "changeteam,deathreview,sniper,jip,nocompress_0_3_6,customloadouts,damagenumbers,ctfjoin,efirepacket,incompleteloadouts,cphysics,spawnhealth" + (MPAudioTaunts.AClient.active ? ",audiotaunts":""));
