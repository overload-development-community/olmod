...
namespace GameMod {
    ...
    class MPTweaksAcceptedToLobby
    {
        private static void Prefix(AcceptedToLobbyMessage accept_msg)
        {
            ...
            caps.Add("SupportsTweaks", "changeteam,deathreview,sniper,jip,nocompress_0_3_6,customloadouts,shipselection,damagenumbers" + (MPAudioTaunts.AClient.active ? ",audiotaunts":""));
